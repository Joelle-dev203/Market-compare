    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div x-show="mobileMenu" x-cloak class="md:hidden bg-white border-t border-gray-100 py-4 px-4">
            <div class="flex flex-col space-y-3">
                ...
                <a href="#" class="text-gray-700 hover:text-emerald-600 font-medium">Flights</a>
                <a href="#" class="text-gray-700 hover:text-emerald-600 font-medium">Buses</a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                  ...
                  <li><a href="{{ route('help') }}" class="hover:text-emerald-600 transition">Help Center</a></li>
                        ...
                        <a href="{{ route('faq') }}" class="hover:text-emerald-600 transition">FAQ</a>
